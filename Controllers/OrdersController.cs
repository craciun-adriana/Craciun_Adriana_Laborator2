...
namespace Craciun_Adriana_Laborator2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(Craciun_Adriana_Laborator2Context context)
        {
            _context = context;
        }
        ...
        {
            var craciun_Adriana_Laborator2Context = _context.Order.Include(o => o.Book).Include(o => o.Customer);
